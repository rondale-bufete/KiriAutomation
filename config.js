module.exports = {
    ...
    // ===========================================
    VPS_BASE_URL: process.env.VPS_BASE_URL || 'https://crca-artifacts-contentmanagement.site', // Change this to your VPS domain when ready
    ...
    // ===========================================
    CI4_BASE_URL: process.env.CI4_BASE_URL || 'https://crca-artifacts-contentmanagement.site', // Change this to your CI4 domain when ready
